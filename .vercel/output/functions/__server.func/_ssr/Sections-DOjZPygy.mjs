			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
					...
					children: nav.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: item.label }), item.isProtected && (isAuthenticated ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "flex size-2 rounded-full bg-emerald-500 animate-pulse",
							title: "Authorized Section Access"
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, { className: "size-3 text-muted-foreground/70" }))]
					}, item.key))
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						isAuthenticated && user ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
							asChild: true,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								size: "sm",
								variant: "outline",
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-xs font-semibold text-foreground max-w-[100px] truncate",
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenuLabel, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "flex size-9 items-center justify-center rounded-xl bg-primary/10 text-primary border border-primary/20",
										...
										className: "mt-2 text-[10px] text-muted-foreground font-mono bg-muted p-1.5 rounded",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["Badge: ", user.badgeId] }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["Zone: ", user.zone] }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: ["Division: ", user.division] })
										]
									})]
								}),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuItem, {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Control Room Console" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Radio, { className: "size-3 text-emerald-500 animate-pulse" })]
									})
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuSeparator, {}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenuItem, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LogOut, { className: "size-3.5 mr-2" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Sign Out / Switch User" })]
								})
							]
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, { className: "size-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Authority Login" })]
						}),
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
										...
										children: nav.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: item.label }), item.isProtected && (isAuthenticated ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
												variant: "outline",
												className: "text-[10px] bg-emerald-500/10 text-emerald-600 border-emerald-500/20",
												children: "Unlocked"
											}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, { className: "size-3.5 text-muted-foreground" }))]
										}, item.key))
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "pt-2",
										children: isAuthenticated && user ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "space-y-3",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, { className: "size-4" }), " Authority Login"]
										})
									})
								]
							})
...
function SiteFooter() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto max-w-6xl px-4 py-12 text-sm text-muted-foreground",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "grid grid-cols-1 md:grid-cols-4 gap-8 pb-8 border-b border-border/60",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									...
									children: "Live Train Tracking"
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: "/network",
									className: "hover:text-primary transition-colors",
									children: "Pan-India Rail Map"
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: "/pnr",
									className: "hover:text-primary transition-colors",
									children: "PNR Status & Berths"
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: "/connecting-impact",
									className: "hover:text-primary transition-colors",
									children: "Connecting Train Risk"
								}) })
							]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-xs font-semibold uppercase tracking-wider text-foreground",
							children: "Operations & Dev"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
							className: "space-y-1.5 text-xs",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: "/control-room",
								className: "hover:text-primary transition-colors font-medium",
								children: "Section Control Room 🔒"
							}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/developer",
								className: "hover:text-primary transition-colors text-primary font-medium flex items-center gap-1",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "REST API & OpenAPI" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "size-3" })]
							}) })]
						})]
					})
				]
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
					...
					" RailDristhi • Smart India Hackathon (SIH 2026)"
				] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-muted-foreground/80",
					children: "Independent AI & Transit Telemetry System"
				})]
			})]
		})
	});
...
//#endregion
export { Sheet as a, SheetTitle as c, SiteHeader as d, Stations as f, Networks as i, SheetTrigger as l, Faq as n, SheetContent as o, Features as r, SheetHeader as s, ApiBanner as t, SiteFooter as u };
