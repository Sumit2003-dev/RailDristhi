...
import { a as fmtMinutes, i as delayTone, o as getHaltPlatform, r as delayLabel, t as computeLiveStatus } from "./ssr.mjs";
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "•" }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											className: `inline-flex items-center gap-1 rounded-md px-1.5 py-0.2 text-[8.5px] ${isNextHalt ? "bg-primary text-primary-foreground font-bold shadow-xs" : isTrainHaltedHere ? "bg-amber-500 text-white font-bold shadow-xs" : "border border-border bg-secondary text-secondary-foreground font-semibold"}`,
											title: `Arrival Platform ${row.platform || (row.halt.platform !== "-" ? row.halt.platform : "1")}`,
											children: ["PF ", row.platform || (row.halt.platform !== "-" ? row.halt.platform : "1")]
										}),
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								status && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-2xl border border-primary/25 bg-primary/5 p-5 shadow-card space-y-4",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "flex items-center gap-2",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "flex size-7 items-center justify-center rounded-lg bg-primary text-primary-foreground font-bold text-xs shadow-xs",
													children: "PF"
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
													className: "text-sm font-bold text-foreground",
													children: "Live Arrival Platform & Stoppage Guide"
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "text-[11px] text-muted-foreground",
													children: "Expected platform allocation for approaching station & upcoming halts"
												})] })]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "rounded-md bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30 px-2 py-0.5 font-mono text-[11px] font-bold",
												children: "Active Berth & Platform Sync"
											})]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "size-3.5 text-primary" }), "Approaching Station"]
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className: "flex flex-wrap items-center gap-2 pt-0.5 text-xs text-muted-foreground",
														children: [
															...
															/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
																...
																/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
																	...
																	children: status.nextHalt ? `${Math.max(1, status.nextHalt.dep - status.nextHalt.arr)} min` : "Terminus"
																})
															] })
														]
													})
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														...
														children: "Assigned Arrival"
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "block font-mono text-xs text-emerald-600 dark:text-emerald-400 font-semibold",
														children: "Confirmed Entry"
													})]
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex flex-col items-center justify-center rounded-xl border-2 border-primary bg-primary/10 px-4 py-2 text-center shadow-xs",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "text-[10px] font-extrabold uppercase text-primary tracking-widest",
														children: "PLATFORM"
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "font-mono text-3xl font-black text-primary leading-none mt-0.5",
														children: status.expectedPlatform
													})]
												})]
											})]
										}),
										status.haltStatus.filter((h) => !h.done).length > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "space-y-2 pt-1",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "text-[11px] font-semibold text-muted-foreground",
												children: "Upcoming En-Route Stations & Platforms:"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "grid grid-cols-1 sm:grid-cols-3 gap-2",
												children: status.haltStatus.filter((h) => !h.done).slice(0, 3).map((h) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex items-center justify-between rounded-lg border border-border/70 bg-card/60 p-2.5 text-xs",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className: "min-w-0 flex-1 pr-2",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															className: "font-bold text-foreground truncate",
															children: h.halt.name
														}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
															className: "text-[10px] font-mono text-muted-foreground",
															children: ["ETA: ", h.forecast ? h.forecast.eta : h.scheduled]
														})]
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
														className: "shrink-0 rounded-md bg-secondary border border-border px-2 py-1 font-mono text-xs font-bold text-primary",
														children: ["PF ", h.platform]
													})]
												}, h.halt.code))
											})]
										})
